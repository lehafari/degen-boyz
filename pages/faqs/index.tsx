            ...
            >
              <Collapse title="Who are we">
                <Text size={18}>
                  ...
                  are a Web 3 smart contract built on the Solana blockchain that
                  allows users to open Lootboxes in Sol and win Sol in return.
                  There is a 4% transaction fee for every Lootbox opened which
                  is split up into:
                </Text>
                <ul>
                  <li>
              ...
              <Collapse title="what are the prizes">
                ...
                <ol>
                  ...
                  <li>
                    <Text size={18}>
                      Fee wallet : 7RkSs75YG6kVg8PEHoSUFGukZFBqe44onubzBAtRX9pZ
                    </Text>
                  </li>
                </ol>
              </Collapse>
              <Collapse title="what are the prizes">
                <Container display="flex" justify="flex-start" fluid>
                  <TwitterIcon
                    sx={{
                      color: 'white',
                      fontSize: '2rem',
